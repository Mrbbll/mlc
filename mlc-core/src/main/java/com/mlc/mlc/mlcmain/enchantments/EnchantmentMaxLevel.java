...
public class EnchantmentMaxLevel {
    ...
    static {
        maxLevelMap.put(VeinMine.VEINMINE,3);
        maxLevelMap.put(Enchantment.SHARPNESS,7);
        maxLevelMap.put(Enchantment.EFFICIENCY,7);
        maxLevelMap.put(Enchantment.FORTUNE,5);
        maxLevelMap.put(Enchantment.PROTECTION,6);
    }

    public static int getMaxLevel(Enchantment enchantment) {
        return maxLevelMap.getOrDefault(enchantment,enchantment.getMaxLevel());
    }
}
